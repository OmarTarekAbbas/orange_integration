    ...
    <table class="table table-hover table-striped mt-table">
        <thead>
            <tr>
                ...
                <th>Cancel Rate One</th>
                <th>Cancel Rate Two</th>
        ...
        <tbody>
            <tr>
                ...
                <td> {{ $count_total_all_active_users > 0 ? round(  $count_today_unsub_users / $count_total_all_active_users , 2 ) : 0 }} </td>
                <td> {{ $count_total_all_active_users > 0 ? round(  $count_today_unsub_users / ( $count_total_all_active_users + $count_all_pending_users ) , 2 ) : 0}} </td>
