...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Show Request Orange Webs</h1>
    </div>
</div>
<!--/.row-->
...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-title">
                <h3>Show Request Orange Webs</h3>
            </div>
                ...
                <table class="table table-hover table-striped mt-table">
                    <tbody>
                        <tr>
                            ...
                            <td>{{$show_request_orange_webs->req}} </td>
                        </tr>
                        <tr>
                            <td width='30%' class='label-view text-left' style="font-weight: bold">Response</td>
                            <td>{{$show_request_orange_webs->response}} </td>
                        </tr>
                    </tbody>
                </table>
                <center>
