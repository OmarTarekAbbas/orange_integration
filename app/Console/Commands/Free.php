    ...
    OrangeSubscribe::where('subscribe_due_date', date("Y-m-d"))->where('free', 1)->chunk(1000, function ($orange_subscribes) {
      foreach ($orange_subscribes as $subscriber) {
        ...
        */
        ...
        $expire_message = "باقة أورانج الخير اللي انت مشترك فيها وبتجيلك كل يوم من أورانج هتتجدد من بكره ب 1 جنيه فى اليوم، واستهلاك الإنترنت سوف يخصم من الباقة الخاصة بك، ولإلغاء الإشتراك ارسل 0215  إلى 6124 مجانا.";
