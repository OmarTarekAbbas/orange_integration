    ...
    OrangeSubscribe::where('subscribe_due_date', date("Y-m-d"))->where('free', 1)->chunk(1000, function ($orange_subscribes) {
      foreach ($orange_subscribes as $subscriber) {
        ...
        */
        ...
        $expire_message = "خدمة الفرسان اللي انت مشترك فيها وبتجيلك كل يوم من أورنج هتتجدد ب 1 جنيه فى اليوم، و لسة عندك الفرصة تكون فائز ب 5000 جنيه يوميًا طوال شهر رمضان لما تحل لغز الفرسان واستهلاك الإنترنت سوف يخصم من الباقة الخاصة بك، ولإلغاء الإشتراك ارسل **** إلى  6122مجانا.";
